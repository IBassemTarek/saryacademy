    ...
    return Column(
      children: [
          ...
          children: [
            ...
            LocaleText(
              ...
              style: Theme.of(context)
                  .textTheme
                  .headline1
                  .copyWith(color: kHeaderColor.withOpacity(1), fontSize: 30),
            ),
          ],
        ),
        SizedBox(
        ...
        Builder(builder: (context) {
          if ((medicalHistoryCard.isEmpty && title == "Medical history") ||
              (vaccinationCard.isEmpty && title == "Medical history") ||
              (absenceCard.isEmpty && title == "Medical history"))
            return Container(
              ...
              child: Padding(
                ...
                child: Center(
                  ...
                  style: Theme.of(context).textTheme.headline1.copyWith(
                      color: kbackgroundColor.withOpacity(1), fontSize: 23),
                  textAlign: TextAlign.center,
                )),
              ),
            );
          if ((medicalHistoryCard == null && title == "Medical history") ||
              (vaccinationCard == null && title == 'Vaccinations') ||
              (absenceCard == null && title == 'Absence'))
            return Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.all(Radius.circular(10)),
                color: Colors.white,

          ...
          appBar: AppBar(
            ...
            title: LocaleText("Gallery",
                style: Theme.of(context)
                    .textTheme
                    .headline1
                    .copyWith(color: kIconColor.withOpacity(1), fontSize: 36)),
          ),
          body: Consumer<IsEmptyModel>(
            builder: (_, x, ___) => Builder(builder: (context) {
                    ...
                    ListView.separated(
                        ...
                        itemBuilder: (context, i) {
                          if (_galleries[i].imagesURL.length == 1) {
                            return GalleryOnePhoto(
                              eventTitle: _galleries[i].eventName,
                              imageURL: _galleries[i].imagesURL[0],
                            );
                          } else if (_galleries[i].imagesURL.length == 2) {
                            return GalleryTwoPhotos(
                              eventName: _galleries[i].eventName,
                              imagesURL: _galleries[i].imagesURL,
                            );
                          } else {

            ...
            Container(
              ...
              child: ListView(
                  ...
                  children: [
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                                ...
                                child: FittedBox(
                                    child: Text(
                                        "${prm3ModelData.studentNameE}`s Report",
                                        style: Theme.of(context)
                                            .textTheme
                                            .headline1
                                            .copyWith(
                    ...
                    SizedBox(height: 0.0169 * _width),
                    FutureBuilder(
                        future: PRM3DataBaseServices(uid: childUser.uid)
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState != ConnectionState.done)
                            ...
                            PR3Grades neededGrades = pr2Grades.firstWhere(
                              (element) =>

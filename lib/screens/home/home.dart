            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: Locales.currentLocale(context).toString() == "en" ?  BorderRadius.only(topRight:Radius.circular(30),bottomRight: Radius.circular(30)):
                ...
                child: LocaleText("Alert",
                    ...
                    Theme.of(context).textTheme.subtitle2.copyWith(
                        color: kbackgroundColor.withOpacity(1), fontSize: 35)
                        ),
              ),
              Row(
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: InkWell(
                      ...
                      child: Row(
                        children: [
                          Image.asset(Locales.currentLocale(context).toString() == "ar" ? "assets/images/flags/EN.png":"assets/images/flags/EG.png",height: _height/40,),

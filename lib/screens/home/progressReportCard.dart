                                    ...
                                    alignment: Alignment.centerRight,
                                      ...
                                      children: [
                                          Column(
                                            ...
                                            children: [
                                          Text("Progress",style: Theme.of(context).textTheme.headline1.copyWith( color:kbackgroundColor.withOpacity(1),fontSize: 34)),
                                          Row(
                                            children: [
                                              Text("Report",style: Theme.of(context).textTheme.headline1.copyWith( color:kbackgroundColor.withOpacity(1),fontSize: 34)),
                                          SizedBox(

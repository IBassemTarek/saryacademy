  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: LocaleText("Upcoming events",
        ...
        builder: (_, __) => Padding(
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Container(width: 0.83575 * _width, child: ListOfEvents()),
            ),
          ),
        ),
      ),

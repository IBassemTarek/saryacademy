                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Center(child: Text("مرحلة ما قبل المدرسة 1",style: Theme.of(context).textTheme.bodyText1.copyWith( color:Colors.white,fontSize: 12))),
                              ),
                          InkWell(
                          onTap: ()async{
                          String _url = prm2ModelData.pdf; 
